...
#   Math Functions
    ...
    def findColor(self, factor):
        ...
        low = 95            # decimal for 5F
        high = 255          # decimal for FF

        # Affine interpolation and convert to hex
        color = hex(int(low + factor*(high-low)))

        # Convert to string and return color
        return '#0000'+str(color[2:])
